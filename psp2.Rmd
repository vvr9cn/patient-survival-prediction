...
dfO <- df # keeping an origin copy of df. I suspect we don't want to blanket kill all the omits if we later find those factors are irrelevant. our dataset cuts in half ~Austin
str(df)
summary(df)
...
```{r}
# Fit a random forest for variable selection
