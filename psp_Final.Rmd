...
The results of the plot show that the tuned hyper parameters with model performance measures attain stability at k = 12, so we can try running k with value 12. 

```{r}
# Using optimal parameter k = 12 
...
## Simple Decision Trees to Predict Apache ICU Death Probability
...
nn_fit_2 <- neuralnet(f, data = train_scaled, hidden = c(2,1), linear.output=TRUE) # 45- 50 mins
