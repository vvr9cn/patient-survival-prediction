...
ggplot(data, aes(apache_2_diagnosis,apache_3j_diagnosis)) + geom_point(alpha = 0.3) + geom_smooth(method = lm) + labs(x = "Apache 2 diagnosis", y = "Apache 3 diagnosis") + scale_x_log10() + scale_y_log10()
```
